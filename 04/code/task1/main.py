...
if __name__ == "__main__":  
    ...
    trainset = FacialKeypointsDataset(
        # root_dir="../../data/training_reshaped_stretch/", csv_file="../../data/training_frames_keypoints_resized.csv", transform=transform_color
        # root_dir="../../data/padding_resize/", csv_file="../../data/output_train_simple.csv", transform=transform
        root_dir="../../data/cropped_face_first_padding_resize/", csv_file="../../data/output_train.csv", transform=transform
    )
    testset = FacialKeypointsDataset(
        ...
        # root_dir="../../data/test_padding_resize/", csv_file="../../data/output_test_simple.csv", transform=transform
        root_dir="../../data/test_cropped_face_first_padding_resize/", csv_file="../../data/output_test.csv", transform=transform
    )   
