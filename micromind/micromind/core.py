...
class MicroMind(ABC):
    ...
    def export(
        self, save_dir: Union[Path, str], out_format: str = "onnx", input_shape=None,batch_quant=None
    ) -> None:
        """
        ...
        if out_format == "onnx":
            ...
            convert.convert_to_tflite(self, save_dir, replace_forward=True, batch_quant=batch_quant)
