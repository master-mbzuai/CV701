...
path=params.output_folder + "_e" + str(params.epochs) + "_l" + str(params.lr) + "_" + str(params.opt) + "_" + str(module_name) + "_" + str(activation).split("(")[0] + "_rotate"
...
cutmix_or_mixup = v2.RandomChoice([cutmix, mixup, None])
